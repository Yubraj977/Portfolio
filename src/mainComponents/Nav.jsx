            ...
            <nav className=" fixed w-full top-0  bg-black z-50 font-allerta text-white">
                <div className='flex gap-40 items-between py-4  lg:px-4 md:px-4 '>
                    ...
                    <div className="Middle  items-center gap-4  text-white font-inter hidden lg:flex md:flex z-50 text-base" >
                     ...
                     <button  class="text-white bg-[#24292F] rounded-lg text-sm  text-center inline-flex items-center px-3 ml-40">
                        
                        <a href="https://github.com/Yubraj977" target='blank'><svg class="w-4 h-4 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
